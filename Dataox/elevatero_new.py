class Transport:
    def __init__(self,brand=None,max_speed=None,kind=None):
        self.brand=brand
...
class Car(Transport):
    ...
    def gasoline(self,l):
        if l!=int:
            self.__gasoline_residue=self.__gasoline_residue+l
            print(f'Объем топлива увеличен на {l} л и составляет 320 л')
        else:
